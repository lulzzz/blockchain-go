...
var PEER_ADDRESS = env.peers;//process.env.CORE_PEER_ADDRESS;
var MEMBERSRVC_ADDRESS = env.ca;//process.env.MEMBERSRVC_ADDRESS;
console.log(JSON.stringify(MEMBERSRVC_ADDRESS));

var chain, chaincodeID;

function configureHfc() {

    // Create a chain object used to interact with the chain.
    // You can name it anything you want as it is only used by client.
    chain = hfc.newChain("mySpecialChain");
    ...
    console.log("member services address =" + MEMBERSRVC_ADDRESS.type);
    ...
    function deploy(user) {
        ...
        deployRequest.chaincodePath = "github.com/VitorSousaCode/chaincodes/experimental";
